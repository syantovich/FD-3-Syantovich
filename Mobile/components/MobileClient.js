  ...
  render() {
    ...
    return (
      ...
      <tr className='MobileClient'>
        ...
        <td className='MobileClientFIO'><input type="button" value="Edit" className={"Edit"} onClick={()=>{voteEvents.emit("EsetMode","Edit",this.props.client.id)}}/></td>
        <td className='MobileClientFIO'><input type="button" value="Delete" className={"Delete"} onClick={()=>{voteEvents.emit("Edelete",this.props.client.id)}}/></td>
      </tr>
        </tbody>
    );
